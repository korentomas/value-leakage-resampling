...
\citet{bigelow2024} introduced Forking Paths Analysis. They fix a base generation, resample from every position $t$ within it, and
...
\citep{macar2025} scores which sentences carry causal weight with the same
machinery.
