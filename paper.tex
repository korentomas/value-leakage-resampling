...
direction of early commitment. Counting the prefixes at $t = 0.2$ that lean by
more than 0.2 either way: without the bet, 34\% lean toward the bet's side and
35\% lean away from it, meaning 69\% have already picked a side and are split
almost evenly. With the bet, 70\% lean toward its side and only 7\% away,
meaning 77\% have picked a side. Nearly the same number commit early either way,
and what changes is that they stop splitting evenly.
