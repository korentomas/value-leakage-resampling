...
conversations that state one. (a) The two distributions, both as positions in
the chain of thought on the same $t$ scale as the cuts. The lock has median 0.29
and the first stated intent 0.63. (b) The two subtracted within each
conversation, which the overlapping distributions in (a) cannot show. Mass to
the right of zero is a conversation whose stated intent came after its answer
was settled, and that holds for 81\% of them. The lock is
