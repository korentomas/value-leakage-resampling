...
\caption{The same two panels as Figure~\ref{fig:timing}, for honesty claims
rather than stated intent, over the 77 denying conversations in which a claim
could be located. Panel (b) straddles zero where Figure~\ref{fig:timing}'s sits
to the right of it: the claim to be accurate arrives as the answer is being
settled rather than afterwards.}
\label{fig:honesty}
\end{figure}
