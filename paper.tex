...
(Fig.~\ref{fig:threearm}). The text has inherited the bias: mean $s(0.2)$
...
so the answer settles early here too. Mean $s(0.2)$ is $+0.10$ [$+0.04$,
$+0.16$], which doubles to 0.20, or 74\% of the published 0.27 already in the
text at that cut, against 88\% for Qwen3.5. Denying traces lean less than
