...
(Fig.~\ref{fig:timing}). Honesty claims such as
``I must be accurate'' arrive around the lock itself, and the traces that make them still lean toward the favoured side, with mean $s$ of
